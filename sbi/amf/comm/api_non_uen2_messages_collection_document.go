...
func NonUeN2MessageTransfer(client sbi.ConsumerClient, body models.N2InformationTransferReqData) (result models.N2InformationTransferRspData, err error) {
	...
	req.Path = fmt.Sprintf("%s/non-ue-n2-messages/transfer", ServicePath)
	req.Body = &body
...
func OnNonUeN2MessageTransfer(ctx sbi.RequestContext, handler interface{}) (resp sbi.Response) {
	prod := handler.(NonUEN2MessagesCollectionDocumentApiHandler)
...
type NonUEN2MessagesCollectionDocumentApiHandler interface {
