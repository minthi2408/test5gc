...
func N1N2MessageUnSubscribe(client sbi.ConsumerClient, ueContextId string, subscriptionId string) (err error) {
	...
	req.Path = fmt.Sprintf("%s/ue-contexts/{ueContextId}/n1-n2-messages/subscriptions/{subscriptionId}", ServicePath)
...
func OnN1N2MessageUnSubscribe(ctx sbi.RequestContext, handler interface{}) (resp sbi.Response) {
	prod := handler.(N1N2IndividualSubscriptionDocumentApiHandler)
...
type N1N2IndividualSubscriptionDocumentApiHandler interface {
