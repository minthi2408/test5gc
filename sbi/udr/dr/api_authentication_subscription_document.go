...
*/
func ModifyAuthenticationSubscription(client sbi.ConsumerClient, ueId string, supportedFeatures string, body []PatchItem) (result models.PatchResult, err error) {
